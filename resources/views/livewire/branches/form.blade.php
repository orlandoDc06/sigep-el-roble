<div class="p-6 max-w-xl mx-auto bg-white rounded-lg shadow space-y-4">
    <h2 class="text-2xl font-semibold text-gray">Nueva sucursal</h2>
    ...
    <form wire:submit.prevent="createBranch" enctype="multipart/form-data" class="space-y-4">
        ...
        <div class="relative w-full">
            ...
            <div class="flex items-center space-x-3">
                <label for="fileInput" class="cursor-pointer flex items-center bg-gray text-white px-4 py-2 rounded hover:bg-azul transition">
