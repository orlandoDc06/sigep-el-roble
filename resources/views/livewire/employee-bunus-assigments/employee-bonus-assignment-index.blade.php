<div class="p-4 space-y-4">
    <h1 class="text-2xl font-bold">Asignaciones de Bonos</h1>

    <a href="{{ route('bonuses-assignments.create') }}" 
    ...
    <div class="flex flex-col sm:flex-row gap-2 items-start sm:items-center">
        <input type="text" 
               ...
               placeholder="Buscar por empleado o bono..." 
            ...
            <table class="min-w-full border border-gray-300 text-sm">
                <thead class="bg-gray-100">
                    <tr>
                        ...
                        <th class="border px-4 py-2 text-left">Bono</th>
                ...
                <tbody>
                    @foreach($assignments as $assignment)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="border px-4 py-2">{{ $assignment->bonus->name }}</td>
