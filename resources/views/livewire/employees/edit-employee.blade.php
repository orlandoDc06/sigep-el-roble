            ...
            <form wire:submit.prevent="update" class="p-6 space-y-8">
                ...
                <div class="bg-gray-50 rounded-lg p-6">
                    <div class="flex items-center mb-6">
                        ...
                        <h3 class="text-xl font-semibold text-gray-900">Acceso al Sistema</h3>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-1">
                            ...
                            <p class="text-xs text-gray-500">Mínimo 8 caracteres. Dejar vacío si no desea cambiarla.</p>
                        </div>
                    ...
                    <!-- Información adicional sobre la contraseña -->
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-blue-800">
                                    <strong>Importante:</strong> Solo completa estos campos si deseas cambiar la contraseña del empleado.
                                    Si los dejas vacíos, se mantendrá la contraseña actual.
                                </p>
                            </div>
                        </div>
                    </div>
